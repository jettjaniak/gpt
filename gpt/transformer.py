...
class TransformerLM(nn.Module):
    def __init__(self, vocab_size: int, n_layers: int, n_heads: int, n_ctx: int, d_model: int, d_head: int):
        super().__init__()
...
class Transformer(nn.Module):
    ...
    def __init__(self, vocab_size: int, n_layers: int, n_heads: int, n_ctx: int, d_model: int, d_head: int):
        super().__init__()
        # TODO: masking in first decoder only
        decoder_kwargs = dict(n_heads=n_heads, n_ctx=n_ctx, d_model=d_model, d_head=d_head)
